                            ...
                            <Navbar.Collapse id="basic-navbar-nav">
                                <Nav className="me-auto ms-auto justify-content-end">
                                    ...
                                    <NavDropdown title="Services" id="basic-nav-dropdown">
                                        <NavDropdown.Item href="#action/3.1">Immigration</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.2">Company formation</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Regulatory compliance</NavDropdown.Item>
                                        <NavDropdown.Divider />
                                        <NavDropdown.Item href="#action/3.4">Government liaison</NavDropdown.Item>
                                    </NavDropdown>
